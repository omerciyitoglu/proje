...
namespace CYTOBS
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        {
            MessageBox.Show("Kırmızı Renkli Kutular Dolu Odaları Gösterir");
        }
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into MusteriEkle(Adi,Soyadi,Cinsiyet,Ders,Bölüm,Sınıf,TC,OdaNo,Harc,GirisTarihi,CikisTarihi) values('" + TxtAdi.Text + "','" + TxtSoyadi.Text + "','" + comboBox1.Text + "','" + comboBox2.Text + "','" + comboBoxB.Text + "','" +comboBoxS.Text+ "','" + TxtKimlikNo.Text + "','" + TxtOdaNo.Text + "','" + TxtUcret.Text + "','" + DtpGirisTarihi.Value.ToString("yyyy-MM-dd") + "','" + DtpCikisTarihi.Value.ToString("yyyy-MM-dd") + "')", baglanti);
            komut.ExecuteNonQuery();
            SqlCommand komut2 = new SqlCommand("insert into Sinav(Adi,Soyadi,TC,Ders) values('" + TxtAdi.Text + "','" + TxtSoyadi.Text + "','" + TxtKimlikNo.Text +"','"+comboBox2.Text+ "')", baglanti);
            komut2.ExecuteNonQuery();
            baglanti.Close();

            MessageBox.Show("Öğrenci Kaydı Başarı ile Gerçekleştirildi");
        }
